...
namespace wordembedding {
  ...
  void DistributedWordembedding::ParseAeitherSetting(int argc, char *argv[])
  {
  ...
  void DistributedWordembedding::GetMachineFileAuto()
  {
    std::random_device rd;
    std::mt19937 gen(rd());
    std::uniform_int_distribution<> dis(12401, 12409);
    int result = -1;
    ...
    do
    {
      ...
      result = multiverso::MV_NetBind(0, local_ip);
    } while (result != 0);
    ...
    multiverso::MV_NetConnect(rank, endpoint, option_->server_num);
  ...
  void DistributedWordembedding::MakeBrokerAddress(){
    std::vector<char *> result;
    char * split_symbol_1 = "#";
    char * split_symbol_2 = ":";
